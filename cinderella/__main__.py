...
if START_IMG is None:
    img = "https://telegra.ph/file/9c088b1e42284b55ba1be.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/fateunion")]]
